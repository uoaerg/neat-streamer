...
#might need this 
# export LD_LIBRARY_PATH=/home/tom/code/neat-streamer/neat/build:$LD_LIBRARY_PATH  
...
/usr/bin/cc -DHAVE_NETINET_SCTP_H -DHAVE_SCTP_SEND_FAILED_EVENT \
	...
	-pthread -L/usr/local/lib -Lneat/build/ -lgstreamer-1.0 -lgobject-2.0 -lglib-2.0 -lintl \
